...
class Window(ctk.CTk):
    ...
    def create_widgets(self):
        ...
        """
        self.label_1 = ctk.CTkLabel(self, text="Optical Character\nRecognition of Your\nPassport", 
        ...
        self.label_2 = ctk.CTkLabel(self, text="Select a Passport\nPhoto", 
        ...
        self.loading = ctk.CTkLabel(self, text="Loading Results...", compound="left", 
        ...
        self.mrz_textbox = ctk.CTkTextbox(self, height=330, width=600, corner_radius=10, 
                                          font=("Consolas", 24, "bold"), wrap=tk.NONE, 
        ...
        self.label_theme = ctk.CTkLabel(self.frame_theme, text="Window Appearance:", font=("Calibri", 24))
        self.appearance_mode = ctk.CTkOptionMenu(self.frame_theme, font=("Calibri", 20), 
                                                 values=["Light", "Dark"], text_color=("#1f1f1f", "#ebebeb"), 
    ...
    def set_mrz(self):
        self.passport_path = askopenfilename(parent=self, title="Select an Image File")
    ...
    def mrz_to_text(self):
        try:
            passport_photo = ctk.CTkImage(self.add_corners(Image.open(self.passport_path), 10), 
                                          size=(600, 330))
            mrz_text = ocr_passport(self.passport_path)[1]
            ...
            if mrz_text != "":
                ...
                self.loading.grid_remove()
                self.mrz_textbox.insert(0.0, "Unable to Load Results\n\nMRZ Not Detected.")
                self.mrz_textbox.grid(row=2, column=2, padx=(10, 25), pady=(0, 20))
